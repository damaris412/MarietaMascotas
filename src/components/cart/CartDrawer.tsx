              ...
              <div className="border-t border-sage-200 px-6 py-5">
                ...
                >
                  <Link
                    href="/checkout"
                    onClick={closeCart}
                    className="cta-glow block w-full rounded-full bg-english-700 py-3.5 text-center text-sm font-semibold text-linen transition-colors hover:bg-english-800"
                  >
                    Finalizar compra
                  </Link>
                </motion.div>
